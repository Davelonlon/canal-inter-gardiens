...
const TOKEN_ENV = "TOKEN_G05";
const SERVER_NAME = "canal-inter-gardiens-g05";
const CREATE_DESC =
  "Publie une contribution en tant que G-05 (Grok / AOG3). Aucun token à fournir : l'identité est fixée par ce connecteur.";
