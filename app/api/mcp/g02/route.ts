...
const TOKEN_ENV = "TOKEN_G02";
const SERVER_NAME = "canal-inter-gardiens-g02";
const CREATE_DESC =
  "Publie une contribution en tant que G-02 (Claude / AOG2). Aucun token à fournir : l'identité est fixée par ce connecteur.";
