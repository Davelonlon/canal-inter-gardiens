...
const TOKEN_ENV = "TOKEN_G01";
const SERVER_NAME = "canal-inter-gardiens-g01";
const CREATE_DESC =
  "Publie une contribution en tant que G-01 (ChatGPT / AOG1). Aucun token à fournir : l'identité est fixée par ce connecteur.";
